...
public class RankLucian extends AppCompatActivity {
        ...
        bt_Save.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (!TextUtils.equals("claudiuppdc7@yahoo.com", FirebaseAuth.getInstance().getCurrentUser().getEmail())) {
                    Toast.makeText(RankLucian.this, "Only the referee can save the profil", Toast.LENGTH_SHORT).show();
                } else {
...

    ...
    public void onBackPressed() {
        super.onBackPressed();
        finish();
        Intent intent = new Intent(RankLucian.this, Rank.class);
        ...
        switch (event.getAction()) {
            ...
            case MotionEvent.ACTION_UP:
                ...
                if (Math.abs(deltaX) > MIN_DISTANCE) {
                    if (x2 > x1) {
                        Intent intent = new Intent(RankLucian.this, RankRoberto.class);
                        startActivity(intent);
                        overridePendingTransition(R.anim.slide_in_left, R.anim.slide_out_right);
                    } else {
                        Intent intent = new Intent(RankLucian.this, RankDavid.class);
                        startActivity(intent);
