...
public class RankYaniv extends AppCompatActivity {
    ...
    public static TextView TVPointsWriteYaniv;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.rank_yaniv);
        ...
        TVPointsWriteYaniv = findViewById(R.id.TVPointsWriteYaniv);
...

        ...
        database.getReference("Player").child("Yaniv").child("-dataForYaniv").addListenerForSingleValueEvent(new ValueEventListener() {
            @Override
        ...
        bt_Save.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (!TextUtils.equals("claudiuppdc7@yahoo.com", FirebaseAuth.getInstance().getCurrentUser().getEmail())) {
                    Toast.makeText(RankYaniv.this, "Only the referee can save the profil", Toast.LENGTH_SHORT).show();
                } else {
...

    ...
    private final TextWatcher textWatcher = new TextWatcher() {
        ...
        public void onTextChanged(CharSequence s, int start, int before, int count) {
            ...
            TVPointsWriteYaniv.setText(String.valueOf(points));
