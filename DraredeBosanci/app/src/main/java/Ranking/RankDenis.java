...
public class RankDenis extends AppCompatActivity {
    ...
    public static TextView TVPointsWriteDenis;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        TVPointsWriteDenis = findViewById(R.id.TVPointsWriteDenis);
...

        ...
        database.getReference("Player").child("Denis").child("-dataForDenis").addListenerForSingleValueEvent(new ValueEventListener() {
            @Override
        ...
        bt_Save.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (!TextUtils.equals("claudiuppdc7@yahoo.com", FirebaseAuth.getInstance().getCurrentUser().getEmail())) {
                    Toast.makeText(RankDenis.this, "Only the referee can save the profil", Toast.LENGTH_SHORT).show();
                } else {
...

    ...
    private final TextWatcher textWatcher = new TextWatcher() {
        ...
        public void onTextChanged(CharSequence s, int start, int before, int count) {
            ...
            TVPointsWriteDenis.setText(String.valueOf(points));
